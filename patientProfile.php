...
<?php include('header.html') ;?>
            ...
            <table>
              <tr>
                ...
                <td style="padding-left: ;" >Prasad</td>
              </tr>
              ...
              <tr>
                ...
                <td style="padding-left: ;" >01711111111</td>
              </tr>

              <tr>
                <td style="padding-right: 170px ; padding-left: 0px;">Email</td>
                
                <td style="padding-left: ;" >mail@sem.com</td>
              </tr>
              ...
              <td style="padding-right:  ; padding-left: 0px;">Date Of Birth</td>
                ...
                <td style="padding-left: ;" >11 Jun 1998</td>
              </tr>
              
               <tr>
              <td style="padding-right:  ; padding-left: 0px;">Password</td>
                
                <td style="padding-left: ;" >pass</td>
              </tr>
              <tr>
                <td style="padding-right:  ; padding-left: 0px;">Report</td>
                
                <td style="padding-left: ;" >Good</td>
              </tr>
            </table>
            </center>
...
<div style="float: right; padding-top: 20px;padding-bottom: 100px; margin-right: 510px;">
  <button class=" btn btn--pill btn--green">Edit</button>
